...
Modalita di esecuzione:
  - Solo scraping:           python -m ingestion.scheduler --mode scrape
  - Solo indicizzazione:     python -m ingestion.scheduler --mode index
  - Pipeline completa:       python -m ingestion.scheduler --mode full
  - Solo verifica:           python -m ingestion.scheduler --mode verify
  - Cron job (completa):     0 3 * * 0  cd /path/to/project && python -m ingestion.scheduler --mode full
"""
